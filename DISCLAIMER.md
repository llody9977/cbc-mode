...
This repository exists for **educational and defensive security** purposes: understanding how CBC mode weaknesses work so they can be detected, prevented, and fixed.
